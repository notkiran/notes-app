  ...
  try {
    ...
    const message =
      error.response && error.response.data.message
        ...
        : error.message;
    dispatch({ type: NOTES_LIST_FAILURE, payload: message });
  }
};
    ...
    try {
      ...
      const message =
        error.response && error.response.data.message
          ? error.response.data.message
          : error.message;
      dispatch({ type: NOTES_CREATE_FAILURE, payload: message });
    }
  };
    ...
    try {
      ...
      const message =
        error.response && error.response.data.message
          ? error.response.data.message
          : error.message;
      dispatch({ type: NOTES_UPDATE_FAILURE, payload: message });
    }
  };
    ...
    try {
      ...
      const message =
        error.response && error.response.data.message
          ? error.response.data.message
          : error.message;
      dispatch({ type: NOTES_DELETE_FAILURE, payload: message });
    }
  };
